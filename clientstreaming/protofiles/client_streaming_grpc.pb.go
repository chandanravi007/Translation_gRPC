...
func (c *phoneClient) NumCheck(ctx context.Context, opts ...grpc.CallOption) (Phone_NumCheckClient, error) {
	stream, err := c.cc.NewStream(ctx, &Phone_ServiceDesc.Streams[0], "/phone/NumCheck", opts...)
	if err != nil {
		return nil, err
	}
...
// All implementations must embed UnimplementedPhoneServer
...
// UnimplementedPhoneServer must be embedded to have forward compatible implementations.
...
func (UnimplementedPhoneServer) mustEmbedUnimplementedPhoneServer() {}
...
var Phone_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "protofiles/client_streaming.proto",
}
