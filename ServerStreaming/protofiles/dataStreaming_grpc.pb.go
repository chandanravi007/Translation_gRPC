...
const (
	StreamingService_GetDataStreaming_FullMethodName = "/StreamingService/GetDataStreaming"
)
...
type StreamingServiceClient interface {
	// unary
	GetDataStreaming(ctx context.Context, in *DataRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[DataResponse], error)
}
...
func (c *streamingServiceClient) GetDataStreaming(ctx context.Context, in *DataRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[DataResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StreamingService_ServiceDesc.Streams[0], StreamingService_GetDataStreaming_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
type StreamingService_GetDataStreamingClient = grpc.ServerStreamingClient[DataResponse]
...
type StreamingServiceServer interface {
	// unary
	GetDataStreaming(*DataRequest, grpc.ServerStreamingServer[DataResponse]) error
...
func (UnimplementedStreamingServiceServer) GetDataStreaming(*DataRequest, grpc.ServerStreamingServer[DataResponse]) error {
...
func _StreamingService_GetDataStreaming_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(StreamingServiceServer).GetDataStreaming(m, &grpc.GenericServerStream[DataRequest, DataResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StreamingService_GetDataStreamingServer = grpc.ServerStreamingServer[DataResponse]
...
var StreamingService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "protofiles/dataStreaming.proto",
}
